...
instrucciones = ["1. Sofreir la carne picada", "2. Mezclar el resto de ingredientes", "3. Dejar que rompa a hervir", "4. Dejar cocer durante 20 minutos o hasta que pierda el agua"]

for paso in instrucciones:
    sql = 'INSERT INTO instrucciones (id_receta, paso) VALUES (%s,"%s")' % (ultimoid, paso)
    cursor.execute(sql)

ingredientes = ["1 taza de arroz", "carne picada", "2 vasos de agua", "1 lata de salsa de tomate", "1 cebolla picada", "1 ajo", "1 cucharadita de comino", "1 cucharadita de oregano", "sal y pimienta al gusto", "salsa al gusto"]
